...
- `agent/`: grasp agent, ReAct-style engine, reflection, retry logic.
...
Archived out of this folder (for paper artifact hygiene):

- large result dumps, simulation-only modules, video/figure generation scripts, and other experiment utilities.
